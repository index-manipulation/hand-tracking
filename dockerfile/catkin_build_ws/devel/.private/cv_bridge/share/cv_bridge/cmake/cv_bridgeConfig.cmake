...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /root/catkin_build_ws/src/vision_opencv/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /root/catkin_build_ws/devel/.private/cv_bridge)
  ...
  set(cv_bridge_INSTALL_PREFIX /root/catkin_build_ws/install)
...
if(NOT "/root/catkin_build_ws/src/vision_opencv/cv_bridge/include;/usr/local/include;/usr/local/include/opencv " STREQUAL " ")
  set(cv_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/root/catkin_build_ws/src/vision_opencv/cv_bridge/include;/usr/local/include;/usr/local/include/opencv")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_build_ws/src/vision_opencv/cv_bridge/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/catkin_build_ws/devel/.private/cv_bridge/lib;/root/catkin_build_ws/install/lib;/opt/ros/kinetic/lib)
