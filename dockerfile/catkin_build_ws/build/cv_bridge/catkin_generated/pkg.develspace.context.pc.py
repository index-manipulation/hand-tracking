...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/root/catkin_build_ws/src/vision_opencv/cv_bridge/include;/usr/local/include;/usr/local/include/opencv".split(';') if "/root/catkin_build_ws/src/vision_opencv/cv_bridge/include;/usr/local/include;/usr/local/include/opencv" != "" else []
...
PROJECT_SPACE_DIR = "/root/catkin_build_ws/devel/.private/cv_bridge"
