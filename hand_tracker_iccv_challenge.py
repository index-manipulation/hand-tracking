...
def mono_hand_loop(acq, outSize, config, track=False, paused=False, with_renderer=False):
    ...
    while True:
        ...
        # print(bgr)
        # print('BGR')
        # print('Type:', type(bgr)) # <class 'numpy.ndarray'>
        # print('DType:', bgr.dtype) # uint8
        # print('Shape:', bgr.shape) # (480, 640, 3)
        clb = clbs[0]
        # print('CLB')
        # print('Type:', type(clb)) # <class 'PyMBVCore.CameraMeta'>
        # print(clb)
...
if __name__ == '__main__':
    ...
    acq = OpenCVGrabber('/dataset/hand_example/hand_example_video_only/output.avi',
                        calib_file="res/calib_webcam_mshd_vga.json")
