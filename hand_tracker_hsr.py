...
class HandTracker:
    ...
    def mono_hand_loop(self):
        ...
        count = 0
        im_index = 0
        while im_index < len(file_list):
            im = file_list[im_index]
            # Get the image
            ...
            # Save
            if self.save and count > self.repeat_first_frame:
            ...
            # Update the counter and image index
            count += 1
            if count > self.repeat_first_frame:
                im_index += 1
